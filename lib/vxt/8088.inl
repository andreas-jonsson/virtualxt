...
static struct instruction const opcode_table_8088[0x100] = {
   ...
   {0x3, "ADD Gv Ev", true, 3, &add_3_13},
   {0x4, "ADD AL Ib", false, 4, &add_4_14},
   {0x5, "ADD AX Iv", false, 4, &add_5_15},
   {0x6, "PUSH ES", false, 10, &push_es},
   {0x7, "POP ES", false, 8, &pop_es},
   {0x8, "OR Eb Gb", true, 3, &or_8},
   {0x9, "OR Ev Gv", true, 3, &or_9},
   {0xA, "OR Gb Eb", true, 3, &or_A},
   {0xB, "OR Gv Ev", true, 3, &or_B},
   {0xC, "OR AL Ib", false, 4, &or_C},
   {0xD, "OR AX Iv", false, 4, &or_D},
   {0xE, "PUSH CS", false, 10, &push_cs},
   {0xF, "POP CS", false, 8, &pop_cs},
   {0x10, "ADC Eb Gb", true, 3, &add_0_10},
   {0x11, "ADC Ev Gv", true, 3, &add_1_11},
   {0x12, "ADC Gb Eb", true, 3, &add_2_12},
   {0x13, "ADC Gv Ev", true, 3, &add_3_13},
   {0x14, "ADC AL Ib", false, 4, &add_4_14},
   {0x15, "ADC AX Iv", false, 4, &add_5_15},
   {0x16, "PUSH SS", false, 10, &push_ss},
   {0x17, "POP SS", false, 8, &pop_ss},
   {0x18, "SBB Eb Gb", true, 3, &sub_18_28},
   {0x19, "SBB Ev Gv", true, 3, &sub_19_29},
   {0x1A, "SBB Gb Eb", true, 3, &sub_1A_2A},
   {0x1B, "SBB Gv Ev", true, 3, &sub_1B_2B},
   {0x1C, "SBB AL Ib", false, 4, &sub_1C_2C},
   {0x1D, "SBB AX Iv", false, 4, &sub_1D_2D},
   {0x1E, "PUSH DS", false, 10, &push_ds},
   {0x1F, "POP DS", false, 8, &pop_ds},
   {0x20, "AND Eb Gb", true, 3, &and_20},
   {0x21, "AND Ev Gv", true, 3, &and_21},
   {0x22, "AND Gb Eb", true, 3, &and_22},
   {0x23, "AND Gv Ev", true, 3, &and_23},
   {0x24, "AND AL Ib", false, 4, &and_24},
   {0x25, "AND AX Iv", false, 4, &and_25},
   {0x26, "PREFIX", false, X, &invalid_prefix},
   {0x27, "DAA", false, 4, daa_27},
   {0x28, "SUB Eb Gb", true, 3, &sub_18_28},
   {0x29, "SUB Ev Gv", true, 3, &sub_19_29},
   {0x2A, "SUB Gb Eb", true, 3, &sub_1A_2A},
   {0x2B, "SUB Gv Ev", true, 3, &sub_1B_2B},
   ...
   {0x30, "XOR Eb Gb", true, 3, &xor_30},
   {0x31, "XOR Ev Gv", true, 3, &xor_31},
   {0x32, "XOR Gb Eb", true, 3, &xor_32},
   {0x33, "XOR Gv Ev", true, 3, &xor_33},
   {0x34, "XOR AL Ib", false, 4, &xor_34},
   {0x35, "XOR AX Iv", false, 4, &xor_35},
   {0x36, "PREFIX", false, X, &invalid_prefix},
   {0x37, "AAA", false, 8, aaa_37},
   {0x38, "CMP Eb Gb", true, 3, cmp_38},
   {0x39, "CMP Ev Gv", true, 3, cmp_39},
   {0x3A, "CMP Gb Eb", true, 3, cmp_3A},
   {0x3B, "CMP Gv Ev", true, 3, cmp_3B},
   ...
   {0x84, "TEST Gb Eb", true, 3, &test_84},
   {0x85, "TEST Gv Ev", true, 3, &test_85},
   {0x86, "XCHG Gb Eb", true, 4, &xchg_86},
   {0x87, "XCHG Gv Ev", true, 4, &xchg_87},
   {0x88, "MOV Eb Gb", true, 2, &mov_88},
   {0x89, "MOV Ev Gv", true, 2, &mov_89},
   {0x8A, "MOV Gb Eb", true, 2, &mov_8A},
   {0x8B, "MOV Gv Ev", true, 2, &mov_8B},
   {0x8C, "MOV Ew Sw", true, 2, &mov_8C},
   {0x8D, "LEA Gv M", true, 2, &lea_8D},
   {0x8E, "MOV Sw Ew", true, 2, &mov_8E},
   {0x8F, "POP Ev", true, 12, &pop_8F},
   ...
   {0xA4, "MOVSB", false, 18, &movsb_A4},
   {0xA5, "MOVSW", false, 26, &movsw_A5},
   {0xA6, "CMPSB", false, 30, &cmpsb_A6},
   {0xA7, "CMPSW", false, 30, &cmpsw_A7},
   {0xA8, "TEST AL Ib", false, 4, &test_A8},
   {0xA9, "TEST AX Iv", false, 4, &test_A9},
   {0xAA, "STOSB", false, 11, &stosb_AA},
   {0xAB, "STOSW", false, 15, &stosw_AB},
   {0xAC, "LODSB", false, 16, &lodsb_AC},
   {0xAD, "LODSW", false, 16, &lodsw_AD},
   {0xAE, "SCASB", false, 19, &scasb_AE},
   {0xAF, "SCASW", false, 19, &scasw_AF},
   ...
   {0xC6, "MOV Eb Ib", true, 4, &mov_C6},
   {0xC7, "MOV Ev Iv", true, 4, &mov_C7},
   {0xC8, INVALID},
   {0xC9, INVALID},
   ...
   {0xFE, "GRP4 Eb", true, 0, &grp4_FE},
   {0xFF, "GRP5 Ev", true, 0, &grp5_FF}
};
